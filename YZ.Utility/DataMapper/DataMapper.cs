    ...
    public static class DataMapper
    {
        ...
        public static void FillFieldValue(object entity, string[] pNames, object val, bool propertyNameIgnoreCase, bool skipNotExistProperty)
        {
            ...
            foreach (string propertyName in pNames)
            {
                ...
                {
                    Invoker.PropertySet(pro, realName, TrimValueIfString(val));
                }
                else
                {
                    object tmp = null;
                    ...
                    if (tmp == null)
                    {
                        ...
                        Invoker.PropertySet(pro, realName, TrimValueIfString(tmp));
                    }
                    pro = tmp;
                }
                index++;
        ...
        private static object TrimValueIfString(object value)
        {
            if (value != null)
            {
        ...
        public static object ConvertIfEnum(object value, Type type)
        {
            ...
            if (type.IsEnum)
            {
                ...
                else if (string.Compare(value.ToString(),"false", StringComparison.OrdinalIgnoreCase) == 0)
                {
                    value = 0;
                }
        ...
        /// <summary>
        /// 泛型List转DataTableList
        /// </summary>
        /// <typeparam name="TSource"></typeparam>
        /// <param name="list"></param>
        /// <returns></returns>
        public static DataTable ListToDataTable<TSource>(IList<TSource> list)
        {
