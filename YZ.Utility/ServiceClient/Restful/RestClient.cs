...
namespace YZ.Utility
{
    public class RestClient
    {
        ...
        protected virtual object DeserializeResponseData(string responseTxt, RequestFormat format, Type type)
        {
            ...
            switch (format)
            {
                case RequestFormat.Json:
                    return SerializeHelper.JsonDeserialize(responseTxt, type);
                case RequestFormat.Xml:
                    return SerializeHelper.XmlDeserialize(responseTxt, type);
                case RequestFormat.Raw:
                    return responseTxt;
                default:
                    return SerializeHelper.BinaryDeserialize(responseTxt);
            }
        }
        ...
        protected virtual string SerializeRequestData(object data, RequestFormat format)
        {
            ...
            {
                case RequestFormat.Json:
                    return SerializeHelper.JsonSerialize(data);
                case RequestFormat.Xml:
                    return SerializeHelper.XmlSerialize(data);
                case RequestFormat.Raw:
                    return data.ToString();
                default:
                    return SerializeHelper.BinarySerialize(data);
            }
        }
